							...
							<table cellpadding="22px">
								...
								<tr>
									...
									<td><input type="text" placeholder="Product Code"
										autocomplete="off" id="searchbyid" name="productCode" required></td>
								</tr>
								<tr>
									<td>Product Name</td>
									<td><input type="text" placeholder="Product Name"
										autocomplete="off" name="productName" id="searchbyname"
										required></td>
								</tr>
								<tr>
					...
					<div class="row top-buffer">
						<form id="deleteProduct">
							<table cellpadding="22px" id="updateTable">
								<tr>
									<td align="center" colspan="6"><label
										style="font-size: 24px;"> Delete Product</label></td>
								</tr>
								<tr>
									<td>Product Code</td>
									<td><input type="text" placeholder="Product Code"
